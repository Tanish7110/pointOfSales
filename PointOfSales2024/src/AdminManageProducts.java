...
//  User Defined Function Ends Here 
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(580, 0, 560, 60);

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel2.setText("Add Product");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(290, 60, 150, 50);
        ...
        jLabel4.setBounds(110, 190, 130, 30);

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel5.setText("Photo:");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(110, 310, 120, 30);
        getContentPane().add(tf1);
        tf1.setBounds(330, 130, 230, 40);
        ...
        jScrollPane1.setBounds(330, 190, 234, 90);
        getContentPane().add(jLabel6);
        jLabel6.setBounds(330, 300, 160, 110);
        ...
        jButton1.setBounds(520, 320, 110, 40);

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel7.setText("Category :");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(120, 430, 110, 40);

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        getContentPane().add(jComboBox1);
        jComboBox1.setBounds(330, 430, 260, 40);

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel8.setText("Price :");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(120, 500, 110, 30);
        getContentPane().add(tf2);
        tf2.setBounds(330, 490, 260, 40);

        jLabel9.setFont(new java.awt.Font("Segoe UI", 3, 18)); // NOI18N
        jLabel9.setText("Offer Prize : ");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(120, 560, 120, 40);
        getContentPane().add(tf3);
        tf3.setBounds(330, 560, 260, 40);
        ...
        jButton2.setBounds(220, 700, 180, 50);
        ...
        jLabel10.setBounds(120, 640, 130, 30);
        getContentPane().add(tf4);
        tf4.setBounds(330, 630, 270, 40);

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel11.setText("View Product");
        getContentPane().add(jLabel11);
        jLabel11.setBounds(1080, 90, 160, 40);
        ...
        jScrollPane2.setBounds(902, 152, 500, 410);
        ...
        jButton3.setBounds(1090, 600, 130, 40);
